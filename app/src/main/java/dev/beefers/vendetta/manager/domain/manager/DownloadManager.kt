...
class DownloadManager(
    ...
    suspend fun downloadVendetta(out: File, onProgressUpdate: (Float?) -> Unit) =
        download(
            "https://github.com/Felocord/Xposed/releases/latest/download/app-release.apk",
            out,
            onProgressUpdate
        )
    ...
    suspend fun downloadUpdate(out: File) =
        download(
            "https://github.com/Felocord/Manager/releases/latest/download/Manager.apk",
            out
        ) {
